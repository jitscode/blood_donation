...
List<userbean> list=userdao.getAllRecordsBY(district);
request.setAttribute("list",list);
%>
<h2>Your Details</h2>
<table style="align:center">
<tr><th>Age</th><th>Blood Group</th>
<th>Sex</th><th>State</th><th>District<th>Address</th><th>Mobile</th></tr>

<% for(userbean x:list) { %>

<tr><td><%= x.getAge() %></td><td>
